...
function initAudioEvent(fileStorageNo, filename) {
    ...
    audioPlayer.addEventListener('click', function () {
        ...
        if (audio.paused) {
            // 开始播放当前点击的音频
            audio.play();
            audioPlayer.innerHTML = '<ion-icon name="pause-circle-outline"></ion-icon>';
        } else {
            audio.pause();
            audioPlayer.innerHTML = '<ion-icon name="play-circle-outline"></ion-icon>';
        }
    }, false);
...
function audioEnded() {
    ...
    document.getElementById('audioPlayer').innerHTML = '<ion-icon name="play-circle-outline"></ion-icon>';
}
